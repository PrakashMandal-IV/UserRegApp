...
<asp:Content ID="Content1" runat="server" contentplaceholderid="MainContent">
    <table class="nav-justified" style="height: 603px; width: 76%;">
        ...
        <tr>
            <td style="font-family: Roboto; font-size: 20px; color: rgb(60, 60, 218); font-weight: bolder; height: 59px; text-align: center; " colspan="3">User Managment</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td rowspan="8">
                <asp:GridView ID="UserDepartmentList" CssClass="table table-condensed table-responsive table-hover" runat="server" Height="325px" Width="151px" style="margin-left: 403px" GridLines="None">
        ...
        <tr>
            <td style="width: 309px; height: 63px;"></td>
        ...
        <tr>
            <td style="width: 309px; height: 41px;">
                <asp:DropDownList ID="DepartmentListSearch" style="border:none; border-bottom: 1px solid black;" BorderStyle="None" Width="150pt" Height="20pt" runat="server">
                </asp:DropDownList>
                <asp:Button ID="Button5" style="border:none; width:30pt; height:20pt; "  runat="server" Text="Go" OnClick="SearchDepartment_Click" />
            </td>
            <td style="height: 41px; width: 337px;">
                <asp:Button ID="Clear" runat="server" AutoPostBack="false" BackColor="#99CCFF" style="border: none ; border-radius:5px; padding:5pt; background-image:linear-gradient(to bottom, rgb(253, 207, 207), rgb(216, 66, 66)); color: white;"  BorderStyle="None" Height="41px" OnClick="Clear_Click" Text="Clear All" Width="152px" />
            </td>
